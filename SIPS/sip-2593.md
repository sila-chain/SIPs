---
sip: 2593
title: Escalator fee market change for SIL 1.0 chain
...
!escalator algorithm price chart in Sila Research
...
| Blocks regularly half full, user willing to wait for a good price.  | User can wait for a better price, but may need to resubmit re-signed transactions.                                                                              | User bids under or at the current price tier, and may wait for the price to fall. If waiting too long, user may need to re-submit with a higher price.                         | User can discover the lowest price within their time preference with a single signature.                           |
