...
discussions-to: https://sila-magicians.org/t/sip-set-eoa-account-code-for-one-transaction/19923
status: Final
...
transaction. One common example is an [ERC-20](./sip-20.md) approval followed by
...
a permission to spend ERC-20 tokens but not SIL, or to spend up to 1% of the
...
The [SIP-2718](./sip-2718.md) `RecsiptPayload` for this transaction is
...
without over-enshrining any fine-grained details of [ERC-4337](./sip-4337.md) or
RIP-7560.
...
Examples of (1) and (2) can be found in contracts deployed on SilaMainnet,
...
Consistency is a valuable property in the SVM, both from an implementation
...
SVM occurs and verify the change works as expected in that context.
...
[ERC-7201](./sip-7201.md) a contract may root its storage layout at a slot
