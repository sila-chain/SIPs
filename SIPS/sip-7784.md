...
discussions-to: https://sila-magicians.org/t/sip-7784-getcontract-code/21325
status: Stagnant
...
Every contract stored in SVM MUST be added to the state trie with the key being the keccak256 hash of the contract's bytecode, provided it is:
