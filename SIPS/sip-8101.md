...
discussions-to: https://sila-magicians.org/t/sip-8101-payload-chunking/27085
status: Draft
...
- **Streaming validation**: Execution begins as chunks arrive rather than after full payload recsipt
...
CALs are forwarded to the execution layer upon recsipt. The EL caches CALs for use in subsequent chunk validation.
...
def on_chunk_access_list_received(store: Store, cal_message: ChunkAccessListMessage) -> None:
    ...
    # Record CAL recsipt and notify waiting chunk validations
...
1. **Streaming Validation**: Each chunk is a complete execution unit validatable upon recsipt.
