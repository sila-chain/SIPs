...
description: Predeploy builder deposit and exit request contracts for SIP-7732 builders on the SIP-7685 request bus
author: Cayman (@wemeetagain), Nico Flaig <nflaig@protonmail.com>, Felix Lange <fjl@sila.org>, Justin Traglia <jtraglia@sila.org>
discussions-to: https://sila-magicians.org/t/sip-8282-builder-execution-requests/28699
status: Review
...
The same demand-responsive fee as [SIP-7002](./sip-7002.md) and [SIP-7251](./sip-7251.md) meters submission, tosilaer with the per-block caps and the per-deposit stake.
