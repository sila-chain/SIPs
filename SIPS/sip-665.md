...
Support performant and cheap verification of Ed25519 cryptographic signatures in smart contracts in general by adding a precompiled contract for Ed25519 signature verification to the SVM.

## Abstract

Verification of Ed25519 cryptographic signatures is obviously possible in SVM bytecode. However, the gas cost will be very high, and computationally expensive, as such tight, wide word operations intensive code as required for Ed25519 is not a good fit for the SVM bytecode model.

The addition of a native compiled function, in a precompiled contract, to the SVM solves both cost and performance problems.
...
---------------|----------|--------------------|
| Gsil         | Go       | use cgo with C [libsodium](https://github.com/jedisct1/libsodium)|
| Parity       | Rust     | [sodiumoxide](https://github.com/dnaq/sodiumoxide)|
| PySila   | Python   | [PyNaCl](https://github.com/pyca/pynacl)|
...
1. [go-sila PR #16453](https://github.com/sila/go-sila/pull/16453)
2. [pysila PR #862](https://github.com/sila/pysila/pull/862)
3. [parity PR #8330](https://github.com/paritytech/parity/pull/8330)
4. [cpp-sila PR #4945](https://github.com/sila/cpp-sila/pull/4945)
