...
discussions-to: https://sila-magicians.org/t/sip-1108-reduce-alt-bn128-precompile-gas-costs/3206
status: Final
...
implementation](https://github.com/sila/go-sila) to implement the
...
introduced this change](https://github.com/sila/go-sila/pull/16203),
and corroborated in [a later
note](https://github.com/sila/go-sila/pull/16301#issuecomment-372687543),
...
[4]- [PR comment clarifying gas cost math](https://github.com/sila/SIPs/pull/1987#discussion_r280977066).
...
* [The AZTEC protocol](https://github.com/AztecProtocol/AZTEC) utilizes the elliptic curve precompiles to construct private tokens, with zero-knowledge transaction logic, via the [ERC-1723](https://github.com/sila/SIPs/issues/1723) and [ERC-1724](https://github.com/sila/SIPs/issues/1724) standard.
...
* ZSiler[^1] uses precompiles `ECADD` and `ECMUL` to construct confidential transactions
...
ZSiler transactions currently cost ~`6,000,000` gas. This SIP would reduce this to ~`1,000,000` gas, which makes the protocol more practical.
...
### Parity and Gsil already have fast algorithms that justify reduced gas costs

This SIP does not require Parity or Gsil to deploy new cryptographic libraries, as fast bn128 algorithms have already been integrated into these clients. This goal of proposing this SIP for Istanbul, is to supplement [SIP-1829](./sip-1829.md) (arithmetic over generic elliptic curves), providing an immediate solution to the pressing problem of expensive cryptography, while more advanced solutions are developed, defined and deployed.
...
@vbuterin independently proposed a similar reduction after this SIP was originally created, with similar rationale, as [sila/SIPs#1187](https://github.com/sila/SIPs/issues/1187).
