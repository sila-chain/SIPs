...
author: Lin Oshitani (@linoscope) <lin@nethermind.io>, Justin Drake (@JustinDrake) <justin@sila.org>
discussions-to: https://sila-magicians.org/t/sip-7917-deterministic-proposer-lookahead/23259
status: Final
...
See the [updated beacon chain specs](https://github.com/sila/consensus-specs/blob/cbaa0063979168a94a9c7821f366c6a221319c8e/specs/sila_fulu/beacon-chain.md) in consensus-specs for more details.

## Rationale

### Considered Alternatives

An alternative approach would be to cache the effective balances at the start of epoch `N` so it can be used to calculate the proposer lookahead at the start of epoch `N+MIN_SEED_LOOKAHEAD`. However, this approach would require additional footprint in the beacon state, and would not be able to provide the proposer lookahead to the SVM via the beacon root.
...
See [the spec tests](https://github.com/sila/consensus-specs/tree/cbaa0063979168a94a9c7821f366c6a221319c8e/tests/core/pyspec/sil2spec/test/sila_fulu) in consensus-specs.
