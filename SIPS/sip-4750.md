...
discussions-to: https://sila-magicians.org/t/sip-4750-eof-functions/8195
status: Stagnant
...
Currently, in the SVM everything is a dynamic jump. Languages like Solidity generate most jumps in a static manner (i.e. the destination is pushed to the stack right before, `PUSHn .. JUMP`). Unfortunately however this cannot be used by most SVM interpreters, because of added requirement of validation/analysis. This also restricts them from making optimisations and potentially reducing the cost of jumps.
...
Additionally, SVM keeps track of the index of currently executing section - `current_section_index`.
...
On the other hand, it provides close to zero benefits for the SVM implementations.
