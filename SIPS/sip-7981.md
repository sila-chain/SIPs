...
discussions-to: https://sila-magicians.org/t/sip-7981-increase-access-list-cost/24680
status: Review
...
Furthermore, access lists can circumvent the [SIP-7623](./sip-7623.md) floor pricing by contributing to SVM gas while still leaving a non-negligible data footprint. This enables achieving the maximal possible block size by combining access lists with calldata at a certain ratio.
