...
The derivation uses the EELS `test_ether_transfers_onchain_receivers` benchmark, executed across all major execution-layer clients (Besu, Erigon, Sila, Nethermind, Reth). The benchmark fills blocks with sila transfers to four kinds of receiver, each exercising a different work path:
