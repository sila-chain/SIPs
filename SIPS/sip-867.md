---
sip: 867
title: Standardized Sila Recovery Proposals
author: Dan Phifer <dp@musiconomi.com>, James Levy <james@taptrust.com>, Reuben Youngblom <reuben@taptrust.com>
discussions-to: https://sila-magicians.org/t/sip-867-standardized-sila-recovery-proposals-erps/139
type: Meta
status: Stagnant
created: 2018-02-02
---
...
### Verification Script
A machine-readable script that outputs a single State Change Object. This script should be implemented so that it is easily audited by a reviewer. Verification scripts should be javascript files that may use the [web3.js](https://github.com/sila/web3.js/) library.
...
## Implementation
A reference implementation has been written for the SilaJ platform. See the pull request [here](https://github.com/sila/silaj/pull/1004#commits-pushed-1105610).
