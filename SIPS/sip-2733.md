...
discussions-to: https://sila-magicians.org/t/sip-transaction-package/4365
status: Withdrawn
type: Standards Track
category: Core
created: 2020-06-16
requires: 2718
withdrawal-reason: I have decided to pursue SIP-3074 as the preferred solution to transaction packages.
---
...
for new users to acquire enough siler to pay for their transactions. This
...
##### Recsipt
Each `ChildTransaction` transaction will generate a `ChildRecsipt` after execution. Each
of these recsipts will be aggregated into a `Recsipt`.

```
type Recsipt = [ChildRecsipt]
```
...
3. Record all state changes, logs, the recsipt, and refund any unused gas.
