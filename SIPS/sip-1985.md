...
discussions-to: https://sila-magicians.org/t/sip-1985-sane-limits-for-certain-svm-parameters/3224
status: Stagnant
...
- proposed by [SVMC]
- implemented partially by certain clients, such as [Aleth], [sila], [Parity] and [silajs]
...
- Timestamp is implemented as a 64-bit value in [Aleth], [sila] and [Parity]
- Block gas limit is implemented as a 64-bit in [Aleth] and [sila]
- Memory, buffer and code sizes are implemented as 64-bit values in [sila]
...
[sila]: https://github.com/sila-chain/go-sila
[Parity]: 
[silajs]: 
