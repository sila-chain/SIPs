...
discussions-to: https://sila-magicians.org/t/sip-5027-unlimit-contract-code-size/9010
status: Stagnant
...
The proposal implements a solution to remove the existing 24576-bytes limit of the code size.  Further, the proposal aims to minimize the changes in the client implementation (e.g., Sila) with
...
The reference implementation on Sila is available at [0001-unlimit-code-size.patch](../assets/sip-5027/0001-unlimit-code-size.patch).
