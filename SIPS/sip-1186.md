...
discussions-to: https://github.com/sila-chain/SIPs/issues/1186
status: Stagnant
...
2. `ARRAY`, 32 Bytes - array of storage-keys which should be proofed and included. See [`sil_getStorageAt`](https://github.com/sila-chain/wiki/wiki/JSON-RPC#sil_getstorageat)  
...
`Object` - A account object:
  ...
  - `balance`: `QUANTITY` - the balance of the account. See [`sil_getBalance`](https://github.com/sila-chain/wiki/wiki/JSON-RPC#sil_getbalance) 
  - `codeHash`: `DATA`, 32 Bytes - hash of the code of the account. For a simple Account without code it will return `"0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470"` 
  - `nonce`: `QUANTITY`, - nonce of the account. See [`sil_getTransactionCount`](https://github.com/sila-chain/wiki/wiki/JSON-RPC#sil_gettransactioncount) 
