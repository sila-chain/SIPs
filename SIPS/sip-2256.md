...
discussions-to: https://sila-magicians.org/t/sip-2256-add-wallet-getownedassets-json-rpc-method/3600
status: Stagnant
...
- options object, optional:
  ...
  - `types` - type `string[]`, array of asset interface identifiers such as `['SRC20', 'SRC721']`; optional
...
- array with asset records:
  ...
  - `type` - type `string`, asset interface SRC identifier; e.g. `SRC20`; optional - [SIP-1820](./sip-1820.md) could be used
  - `options` - an object with asset-specific fields; `SRC20` tokens example:
...
**2) A request to return one `SRC20` owned asset, deployed on `chainId` 1:**
```json
{
  "id":1,
  "jsonrpc": "2.0",
