---
sip: 7756
title: EOF/SVM Trace Specification
description: Updates SIP-3155 tracing to add EOF support
author: Martin Holst Swende (@holiman), Marius van der Wijden (@MariusVanDerWijden), Danno Ferrin (@shemnon)
discussions-to: https://sila-magicians.org/t/sip-7756-eof-svm-trace-specification/20806
status: Stagnant
...
SIP-3155 defined a tracing standard for Legacy SVM operations. However, the SVM Object
...
- The client outputs one JSON object per SVM operation executed.
...
Besu, svmone, SilaJS, Geth, Nethermind, and Reth already produce these standard traces in
...
parameterized executions of [test_eof_functions_contract_call_succeed](https://github.com/sila-chain/execution-spec-tests/blob/632d151ea8a71d09a3a0acbdb85d97fa18c8456b/tests/prague/sip7692_eof_v1/sip3540_eof_v1/test_execution_function.py#L304-L335).
