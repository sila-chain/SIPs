...
discussions-to: https://sila-magicians.org/t/sip-2488-deprecate-the-callcode-opcode/3957
status: Stagnant
...
`CALLCODE` became never utilized, but it still puts a burden on SVM implementations.
