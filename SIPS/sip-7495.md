...
discussions-to: https://sila-magicians.org/t/sip-7495-ssz-progressivecontainer/15476
status: Review
...
A new [SSZ composite types](https://github.com/sila/consensus-specs/blob/ad36024441cf910d428d03f87f331fbbd2b3e5f1/ssz/simple-serialize.md#composite-types) is defined:
...
Serialization of `ProgressiveContainer(active_fields)` is identical to [`Container`](https://github.com/sila/consensus-specs/blob/ad36024441cf910d428d03f87f331fbbd2b3e5f1/ssz/simple-serialize.md#vectors-containers-lists).

#### Deserialization

Deserialization of `ProgressiveContainer(active_fields)` is identical to [`Container`](https://github.com/sila/consensus-specs/blob/ad36024441cf910d428d03f87f331fbbd2b3e5f1/ssz/simple-serialize.md#deserialization).
...
The [SSZ Merkleization specification](https://github.com/sila/consensus-specs/blob/ad36024441cf910d428d03f87f331fbbd2b3e5f1/ssz/simple-serialize.md#merkleization) is extended with two helper functions:
