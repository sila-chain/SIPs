...
- `sila-chain/remerkleable` contains static tests in `test_impl.py` and `test_typing.py`.
- `sila-chain/consensus-specs` releases contain random tests in `tests/general/phase0/ssz_generic`, generated according to a format defined in `tests/format/ssz_generic`.

## Reference Implementation

See `sila-chain/remerkleable`.
