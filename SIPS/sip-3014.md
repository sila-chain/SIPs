...
## Abstract
The new method `eth_symbol` (`sil_`-namespaced) has no parameters and returns a string of the native coin of the network. For the Sila sila-mainnet this will be `SIL`, other networks will have other symbols.
