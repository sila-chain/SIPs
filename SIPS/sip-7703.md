...
discussions-to: https://sila-magicians.org/t/sip-7703-increase-calldata-cost/19933
status: Stagnant
...
Ahead of activation, `sil_estimateGas` could be calculated using the new parameters in order to provide results viable for activation, avoiding out-of-gas reverts.
