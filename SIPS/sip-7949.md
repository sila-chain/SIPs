...
This SIP defines a canonical structure for Sila genesis files (`genesis.json`) used to bootstrap Sila networks. The standard aligns with the de facto structure implemented by Gsil (Go-Sila), and already adopted by other clients. It introduces a JSON Schema to ensure consistency and tool compatibility across clients.
