...
description: Transforms Sila’s `randao_reveal` into a per-slot BLS-based VRF by signing the previous epoch’s mix and current slot.
author: Alberto La Rocca (@71104), Aryaethn (@aryaethn)
discussions-to: https://sila-magicians.org/t/sip-7998-turn-randao-reveal-into-a-vrf/24999
status: Draft
