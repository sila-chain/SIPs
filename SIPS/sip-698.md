...
discussions-to: https://github.com/sila-chain/SIPs/issues/698
status: Stagnant
...
This SIP adds an additional opcode to the SVM which will return a finalized blocks reward value. 

## Abstract

In the SVM, the 0x40 opcodes are reserved for `Block Information`. Currently reserved opcodes are:
* `0X40 BLOCKHASH`
* `0X41 COINBASE`
* `0X42 TIMESTAMP`
* `0X43 NUMBER`
