---
sip: 7594
title: SilaPeerDAS - Peer Data Availability Sampling
...
discussions-to: https://sila-magicians.org/t/sip-7594-sila_peerdas-peer-data-availability-sampling/18215
status: Final
...
The detailed specifications are on [sila/consensus-specs](https://github.com/sila/consensus-specs/tree/9d377fd53d029536e57cfda1a4d2c700c59f86bf/specs/sila_fulu/).
...
- `cell_proofs` - list of cell proofs for all `blobs`, including the proofs for the extension indices, for a total of `CELLS_PER_EXT_BLOB` proofs per blob (`CELLS_PER_EXT_BLOB` is the number of cells for an extended blob, defined [in the consensus specs](https://github.com/sila/consensus-specs/tree/9d377fd53d029536e57cfda1a4d2c700c59f86bf/specs/sila_fulu/polynomial-commitments-sampling.md#cells))
