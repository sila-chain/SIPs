...
discussions-to: https://sila-magicians.org/t/sip-6810-ex-post-facto-cascading-revert/13630
status: Stagnant
...
The [SIP-2718](./sip-2718.md) `RecsiptPayload` for this transaction is `rlp([status, budgetUsed, removedLogsBloom, [newRecsiptPayloads]])`, where `newRecsiptPayloads` is a sequential array of the updated recsipts of all reverted transactions.
...
A transaction fee budget is initialized to the value specified by `budget`, denominated in siler.
