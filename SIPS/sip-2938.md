...
Future hard forks may add support for different version numbers, in which case the opcode may take different-sized memory slices and interpret them differently. Two particular potential use cases are [SIP 1559](https://notes.sila.org/@vbuterin/BkSQmQTS8) and the escalator mechanism.
...
See  for an analysis of DoS issues.
