...
**Full-EVM metering model (normative).** The reference cost of an 8130 transaction is what its work costs when metered as ordinary SVM execution, over four phases:
