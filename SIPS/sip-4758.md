...
discussions-to: https://sila-magicians.org/t/sip-4758-deactivate-selfdestruct/8710
status: Stagnant
...
This SIP renames the `SELFDESTRUCT` opcode to `SENDALL`, and replaces its functionality. The new functionality will be only to send all Siler in the account to the caller.
