...
discussions-to: https://sila-magicians.org/t/sip-8296-fixed-cutoff-state-tiering/28772
status: Draft
...
Wallets and RPC providers must update `sil_estimateGas` to charge the surcharge when a write targets Inactive state.
