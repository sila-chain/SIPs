...
[ERC-2335](./sip-2335.md) stores a 32-byte BLS scalar. Lean Sila replaces BLS validator keys with XMSS for post-quantum security. An XMSS secret can also be reduced to a small seed, so the *container* needs only modest change. The danger is elsewhere.
