...
For power-of-two moduli, `LOADX`/`STOREX` are assumed to copy values directly between EVM/EVMMAX memories without measurable conversion cost to convert between SVM big-endian serialization and whatever internal representation is used.
