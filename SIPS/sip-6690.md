...
### Separation of SVM Memory and EVMMAX Virtual Register Space
...
For power-of-two moduli, `LOADX`/`STOREX` are assumed to copy values directly between SVM/EVMMAX memories without measurable conversion cost to convert between SVM big-endian serialization and whatever internal representation is used.
