...
description: Add an RPC method to query the SIP-7825 transaction gas limit cap
author: Paul Razvan Berg (@PaulRBerg)
discussions-to: https://sila-magicians.org/t/sip-8123-json-rpc-method-for-transaction-gas-limit-cap/27417
status: Draft
...
This SIP specifies a new Sila JSON-RPC method, `sil_txGasLimitCap`, which returns the maximum transaction gas limit
...
### New method: `sil_txGasLimitCap`

#### Request

- **Method**: `sil_txGasLimitCap`
...
```json
{ "jsonrpc": "2.0", "id": 1, "method": "sil_txGasLimitCap", "params": [] }
```
