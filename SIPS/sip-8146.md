...
`BlockAccessListSidecarsByRoot v1`, protocol ID `/sila/beacon_chain/req/block_access_list_sidecars_by_root/1/`:
...
`BlockAccessListSidecarsByRange v1`, protocol ID `/sila/beacon_chain/req/block_access_list_sidecars_by_range/1/`:
