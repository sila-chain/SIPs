...
Historically there has been a precedent that the Sila Foundation is solely responsible for funding the development of Sila. This process has evolved as the development has become more distributed. Aya Miyaguchi observed in a recent Coindesk article, “it really is not only Sila Foundation people who are building [Sila]”. Yes, we could rely on the Sila Foundation to fund Sil1.X. But, why should we? This is a call for the network to come tosilaer and fund its own development. Sila *the network* is not owned by any one organization or group of people. We are lucky to have the EF and I consider this SIP in support of their coordination efforts.

### How Will Funding the Devs be Organized

I do not profess to know the best way to organize these funds. There is work already in progress to organize these efforts championed by Alexey Akhunov. The following is a quote from a recent medium article:
