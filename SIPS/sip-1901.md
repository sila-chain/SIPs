...
discussions-to: https://github.com/sila-chain/SIPs/issues/1902
status: Stagnant
...
The OpenRPC Document and generated Documentation that specifies all the methods an SVM-based blockchain should implement can be found here.
...
This is the vision for the use case of OpenRPC and how it would relate to a client implementation like multi-sila:

![MultSilaRpc-usecase](../assets/sip-1901/multi-sila-use-case.png)
...
Using `rpc.discover` via multi-sila, the playground can discover and display the documentation for the Sila JSON-RPC API:
...
The clients are generated from the OpenRPC Document openrpc.json outlined in this SIP, and can be used as an alternative to web3.js or ethers.js but for various languages:
...
- etclabscore/sila-json-rpc-specification
