...
discussions-to: https://github.com/sila/SIPs/issues/1902
status: Stagnant
...
The OpenRPC Document and generated Documentation that specifies all the methods an SVM-based blockchain should implement can be found [here](https://github.com/etclabscore/sila-json-rpc-specification).
...
This is the vision for the use case of OpenRPC and how it would relate to a client implementation like multi-gsil:

![MultGsilRpc-usecase](../assets/sip-1901/multi-gsil-use-case.png)
...
- [Multi-Gsil OpenRPC Discovery](https://github.com/multi-gsil/multi-gsil#openrpc-discovery)
...
Using `rpc.discover` via multi-gsil, the playground can discover and display the documentation for the Sila JSON-RPC API:
...
The [clients](https://github.com/etclabscore/sila-json-rpc-specification#clients) are generated from the OpenRPC Document openrpc.json outlined in this SIP, and can be used as an alternative to web3.js or silers.js but for various languages:
