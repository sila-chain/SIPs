...
discussions-to: https://sila-magicians.org/t/sip-4803-limit-transaction-gas-to-a-maximum-of-2-63-1/8296
status: Stagnant
...
Due to the nature of RLP encoding, there is no fixed upper bound for the value, but most implementations limit it to 256-bits. Furthermore, most client implementations (such as gsil) internally handle gas as a 64-bit value.
