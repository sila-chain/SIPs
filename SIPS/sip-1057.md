...
Sila's approach is to incentivize a geographically-distributed community of miners with a low barrier to entry on commodity hardware.  As stated in the Yellow Paper:
...
* Bob Rao - ProgPoW Hardware Audit PDF
