...
author: Péter Szilágyi <peterke@gmail.com>, Felix Lange <fjl@sila.org>
discussions-to: https://github.com/sila/SIPs/issues/2125
status: Final
...
Instead of just taking the first 4 bytes of a Keccak256 hash (seems odd) or XOR-ing all the 4-byte groups (messy), CRC32 is a better alternative, as this is exactly what it was designed for. IEEE CRC32 is also used by silernet, gzip, zip, png, etc, so every programming language support should not be a problem.
...
Gsil: https://github.com/sila/go-sila/tree/master/core/forkid
