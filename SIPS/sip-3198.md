...
discussions-to: https://sila-magicians.org/t/sip-3198-basefeeopcode/5162
status: Final
...
## Simple Summary
Adds an opcode that gives the SVM access to the block's base fee.
...
### Gas cost
The value of the base fee is needed to process transactions. That means it's value is already available before running the SVM code.
