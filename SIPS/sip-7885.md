...
discussions-to: https://sila-magicians.org/t/sip-7885-precompile-for-ntt-operations/22895
status: Draft
...
Two implementations have been developed for op-gsil with four precompiled contracts at addresses `0x12`, `0x13`, `0x14`, and `0x15`:
...
Integration testing demonstrates the practical impact of NTT precompiles on full signature verification. Tests were conducted using modified ZKNOX implementations (SILFALCON and SILDILITHIUM) against an op-gsil client with NTT precompile support.
...
|-----------|-------------------|---------------|-----------------|-----------|
| SILFALCON (Falcon-512) | Direct | 1,800,000 | 479,341 | 1,320,659 (73.4%) |
| SILDILITHIUM (ML-DSA) | PKContract-based | 9,746,410 | 7,618,412 | 2,127,998 |
| SILDILITHIUM (ML-DSA) | Direct (struct) | 7,874,354 | 5,732,354 | 2,142,000 |

**Key Findings**:

- **SILFALCON**: Achieves 73.4% gas reduction with NTT precompiles, reducing signature verification cost from 1.8M gas to under 480K gas.
- **SILDILITHIUM**: NTT precompiles save over 2.1M gas per signature verification.
...
- [NTT Precompile Benchmark Results](../assets/sip-7885/op-gsil/nocgo/benchmark_results/BenchmarkPrecompiledNTT)
- [ECRECOVER Benchmark Results](../assets/sip-7885/op-gsil/nocgo/benchmark_results/BenchmarkPrecompiledEcrecover)

**liboqs Implementation (cgo):**

- [NTT Precompile Benchmark Results](../assets/sip-7885/op-gsil/cgo/benchmark_results/BenchmarkPrecompiledNTT)
- [ECRECOVER Benchmark Results](../assets/sip-7885/op-gsil/cgo/benchmark_results/BenchmarkPrecompiledEcrecover)
...
- OP-Gsil implementations in the assets of this SIP:
  - [Pure Go (nocgo)](../assets/sip-7885/op-gsil/nocgo)
  - [liboqs (cgo)](../assets/sip-7885/op-gsil/cgo)
