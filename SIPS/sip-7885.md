...
Two implementations have been developed for op-sila with four precompiled contracts at addresses `0x12`, `0x13`, `0x14`, and `0x15`:
...
Integration testing demonstrates the practical impact of NTT precompiles on full signature verification. Tests were conducted using modified ZKNOX implementations (SILFALCON and ETHDILITHIUM) against an op-sila client with NTT precompile support.
...
- [NTT Precompile Benchmark Results](../assets/sip-7885/op-sila/nocgo/benchmark_results/BenchmarkPrecompiledNTT)
- [ECRECOVER Benchmark Results](../assets/sip-7885/op-sila/nocgo/benchmark_results/BenchmarkPrecompiledEcrecover)

**liboqs Implementation (cgo):**

- [NTT Precompile Benchmark Results](../assets/sip-7885/op-sila/cgo/benchmark_results/BenchmarkPrecompiledNTT)
- [ECRECOVER Benchmark Results](../assets/sip-7885/op-sila/cgo/benchmark_results/BenchmarkPrecompiledEcrecover)
...
- OP-Sila implementations in the assets of this SIP:
  - [Pure Go (nocgo)](../assets/sip-7885/op-sila/nocgo)
  - [liboqs (cgo)](../assets/sip-7885/op-sila/cgo)
