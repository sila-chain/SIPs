...
*Citing from the [`GetBlockHeaders` spec definition](https://github.com/sila-chain/devp2p/blob/40ab248bf7e017e83cc9812a4e048446709623e8/caps/eth.md#getblockheaders-0x03):*
...
The node that receives the `GetBlockHeaders` command should answer it with the [`BlockHeaders`](https://github.com/sila-chain/devp2p/blob/40ab248bf7e017e83cc9812a4e048446709623e8/caps/eth.md#blockheaders-0x04) response command accordingly.

*Citing from the [`BlockHeaders` spec definition](https://github.com/sila-chain/devp2p/blob/40ab248bf7e017e83cc9812a4e048446709623e8/caps/eth.md#blockheaders-0x04):* 
