...
| `TX_CREATE_COST`            | Defined as `32000` in the Sila Execution Layer Specs    |
| `STACK_DEPTH_LIMIT`         | Defined as `1024` in the Sila Execution Layer Specs |
| `GAS_CODE_DEPOSIT`          | Defined as `200` in the Sila Execution Layer Specs          |
| `TX_DATA_COST_PER_ZERO`     | Defined as `4` in the Sila Execution Layer Specs        |
| `TX_DATA_COST_PER_NON_ZERO` | Defined as `16` in the Sila Execution Layer Specs       |
