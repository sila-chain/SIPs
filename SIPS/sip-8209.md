...
discussions-to: https://sila-magicians.org/t/sip-8209-commit-reveal-transaction-frames/28105
status: Draft
...
- `gas_limit = 0`: The frame itself does not execute SVM code.
...
4. The transaction recsipt records each commitment's index, the gas payer address, and the escrowed amount.
...
2. No SVM execution occurs - no state changes beyond the gas payment.
