...
discussions-to: https://sila-magicians.org/t/sip-7928-block-level-access-lists/23337
status: Review
...
- Reduced execution time to `parallel IO + parallel SVM`
...
BAL verification occurs alongside parallel IO and SVM operations without delaying block processing.
