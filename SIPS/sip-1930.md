...
discussions-to: https://github.com/sila/SIPs/issues/1930
category: Core
status: Stagnant
created: 2019-04-10
---
...
```
see https://github.com/sila/go-sila/blob/7504dbd6eb3f62371f86b06b03ffd665690951f2/core/vm/gas.go#L41-L48
...
As for SIP-165, the issue already exists in the example implementation presented in the SIP. Please see the details of the issue [here](https://github.com/sila/SIPs/pull/881#issuecomment-491677748)
...
Similarly to the previous solution, an SVM mechanism would be much better.
...
None fully implemented yet. But see Specifications for an example in gsil.
