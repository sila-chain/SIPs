...
The [execution block header](https://github.com/sila-chain/devp2p/blob/5713591d0366da78a913a811c7502d9ca91d29a8/caps/eth.md#block-encoding-and-validity) is extended with a new field, `system-logs-root`.
...
Tosilaer with [SIP-7708](./sip-7708.md) this SIP provides the ability for wallets to compute the exact SIL balance from logs without requiring download of every single block header and all withdrawals.
