...
EOFv1 as scoped in [SIP-7692] removes code introspection capabilities from the SVM, including the `EXTCODESIZE` instruction (in [SIP-3540]). This makes it hard for [SRC-721] and [SRC-1155] standard contracts to be implemented, as they rely on discovering whether a token's `safeTransfer` call target was an EOA or a contract account:
...
[Sila Execution Layer Spec Constants] :https://github.com/sila-chain/execution-specs/blob/1adcc1bfe774798bcacc685aebc17bd9935078c3/src/sila-chain/cancun/vm/gas.py#L65-L66
