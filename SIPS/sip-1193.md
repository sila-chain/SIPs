...
- [sil-provider](https://www.npmjs.com/package/eth-provider)
...
[`sil_` subscription methods](https://geth.sila.org/docs/rpc/pubsub) and [`shh_` subscription methods](https://github.com/ethereum/go-ethereum/wiki/Whisper-v6-RPC-API#shh_subscribe) rely on this event to emit subscription updates.
