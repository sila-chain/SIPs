...
discussions-to: https://sila-magicians.org/t/sip-8071-prevent-using-consolidations-as-withdrawals/26037
status: Draft
...
This is done to handle the case when there are multiple consolidations with the same target and each of them doesn't exceed the max effective balance while all of them tosilaer do.
