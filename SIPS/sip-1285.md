...
discussions-to: https://sila-magicians.org/t/sip-1285-increase-gcallstipend-gas-in-the-call-opcode/941
status: Stagnant
...
For an implementation example you can find a Gsil client implementation linked [here](https://github.com/ben-kaufman/go-sila/tree/sip-1285). The actual change to the code can be found [here](https://github.com/ben-kaufman/go-sila/blob/sip-1285/params/protocol_params.go#L41).
