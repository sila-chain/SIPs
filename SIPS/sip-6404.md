...
discussions-to: https://sila-magicians.org/t/sip-6404-ssz-transactions/12783
status: Draft
...
This SIP defines a migration process of [SIP-2718](./sip-2718.md) Recursive-Length Prefix (RLP) transactions to [Simple Serialize (SSZ)](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/ssz/simple-serialize.md).
...
| Name | Value |
| - | - |
| [`BYTES_PER_FIELD_ELEMENT`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/sila_deneb/polynomial-commitments.md#constants) | `uint64(32)` |
| [`FIELD_ELEMENTS_PER_BLOB`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/sila_deneb/polynomial-commitments.md#blob) | `uint64(4096)` |

| Name | SSZ equivalent |
| - | - |
| [`Hash32`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/phase0/beacon-chain.md#custom-types) | `Bytes32` |
| [`ExecutionAddress`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/bellatrix/beacon-chain.md#custom-types) | `Bytes20` |
| [`VersionedHash`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/sila_deneb/beacon-chain.md#custom-types) | `Bytes32` |
| [`KZGCommitment`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/sila_deneb/polynomial-commitments.md#custom-types) | `Bytes48` |
| [`KZGProof`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/sila_deneb/polynomial-commitments.md#custom-types) | `Bytes48` |
| [`Blob`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/sila_deneb/polynomial-commitments.md#custom-types) | `ByteVector[BYTES_PER_FIELD_ELEMENT * FIELD_ELEMENTS_PER_BLOB]` |
...
The [execution block header's `txs-root`](https://github.com/sila/devp2p/blob/bc76b9809a30e6dc5c8dcda996273f0f9bcf7108/caps/sil.md#block-encoding-and-validity) is transitioned from MPT to SSZ.
...
When building a consensus `ExecutionPayload`, the [`transactions`](https://github.com/sila/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/sila_deneb/beacon-chain.md#executionpayload) list is no longer opaque and uses the new `Transaction` type, aligning the `transactions_root` across execution blocks and execution payloads.
