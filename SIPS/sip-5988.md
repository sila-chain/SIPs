...
discussions-to: https://sila-magicians.org/t/sip-5988-add-poseidon-hash-function-precompile/11772
status: Stagnant
...
This SIP introduces a new precompiled contract which implements the hash function used in the Poseidon cryptographic hashing algorithm, for the purpose of allowing interoperability between the SVM and ZK / Validity rollups, as well as introducing more flexible cryptographic hash primitives to the SVM.
...
Sila adopts a rollup centric roadmap and hence must adopt facilities for L2s to be able to communicate with the SVM in an optimal manner.
...
TODO: Add initial Gsil implementation-->

## Security Considerations

Quoting Vitalik Buterin from `Arithmetic hash based alternatives to KZG for proto-danksharding` thread on SilResearch:
...
- Polygon uses Poseidon for Hermez ZK-SVM.
