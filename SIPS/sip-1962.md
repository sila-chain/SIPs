...
discussions-to: https://sila-magicians.org/t/generalised-precompile-for-elliptic-curve-arithmetics-and-pairings-working-group/3208/2
...
Due to actuve development of the precompile and a lot of ongoing changes there is a single [source of truth](https://github.com/matter-labs/sip1962/tree/master/documentation). It covers binary interface, gas schedule, integration guide for existing implementations.
...
- BLS12-381 curve, 381 bit modulus, 255 bit scalar field, no native arithmetic is available in SVM for this
...
Functionality of the new precompile itself does not affect any existing functionality of Sila or SVM.
...
## Implementation
There is an ongoing implementation effort [here](https://github.com/matter-labs/sip1829). Right now:
