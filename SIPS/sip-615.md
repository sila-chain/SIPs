...
* The SVM data stack, (as defined in the [Yellow Paper](https://ethereum.github.io/yellowpaper/paper.pdf)) usually just called “the stack.”
...
_Execution_ is as defined in the [Yellow Paper](https://ethereum.github.io/yellowpaper/paper.pdf)—a sequence of changes in the SVM state.  The conditions on valid code are preserved by state changes.  At runtime, if execution of an instruction would violate a condition the execution is in an exceptional halting state.  The Yellow Paper defines five such states.
>**1**  Insufficient gas
...
* [A Lem formalization of SVM and some Isabelle/HOL proofs](https://github.com/pirapira/eth-isabelle)
...
* [Sila 2.0 Specifications](https://github.com/ethereum/eth2.0-specs)
...
*[A Lem formalization of SVM 1.5](https://github.com/seed/eth-isabelle/tree/evm15)
