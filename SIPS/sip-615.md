...
discussions-to: https://sila-magicians.org/t/sip-615-subroutines-and-static-jumps-for-the-svm-last-call/3472
created: 2016-12-10
---
...
Valid SIP-615 SVM bytecode begins with a valid header.  This is the magic number  ‘\0SVM’ followed by the semantic versioning number '\1\5\0'.  (For Wasm the header is '\0asm\1').
...
* The SVM data stack, (as defined in the Yellow Paper) usually just called “the stack.”
...
* The _stack pointer_ `SP` corresponds to the Yellow Paper's substate `s` of the machine state.
...
_Execution_ is as defined in the Yellow Paper—a sequence of changes in the SVM state.  The conditions on valid code are preserved by state changes.  At runtime, if execution of an instruction would violate a condition the execution is in an exceptional halting state.  The Yellow Paper defines five such states.
>**1**  Insufficient gas
...
* Defining the Sila Virtual Machine for Interactive Theorem Provers
* [Sila 2.0 Specifications](https://github.com/sila-chain/consensus-specs)
...
*[A Lem formalization of SVM 1.5](https://github.com/seed/sil-isabelle/tree/svm15)
