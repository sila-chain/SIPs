...
**Note on `USABLE_BYTES_PER_FIELD_ELEMENT`**: Field elements are interpreted big-endian (see [execution-specs](https://github.com/sila-chain/execution-specs/blob/6137bb32f9b8eda6194096992cb97b28be06957d/src/sila-chain/crypto/kzg.py#L102)). This SIP sets the first byte (MSB) to zero to ensure that every 32-byte element is a canonical BLS field element (`value < BLS_MODULUS`).
