...
discussions-to: https://sila-magicians.org/t/sip-8058-contract-bytecode-deduplication-discount/25933
status: Draft
...
- RPC methods like `sil_estimateGas` SHOULD account for potential deduplication discounts when access lists are present
