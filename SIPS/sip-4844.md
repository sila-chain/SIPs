...
description: Shard Blob Transactions scale data-availability of Sila in a simple, forwards-compatible manner.
...
discussions-to: https://sila-magicians.org/t/sip-4844-shard-blob-transactions/8430
status: Final
...
accessed by SVM execution, but whose commitment can be accessed.
...
| `HASH_OPCODE_GAS` | `3` |
| [`MIN_EPOCHS_FOR_BLOB_SIDECARS_REQUESTS`](https://github.com/sila/consensus-specs/blob/4de1d156c78b555421b72d6067c73b614ab55584/configs/sila-mainnet.yaml#L148) | `4096` |
...
Throughout this proposal we use cryptographic methods and classes defined in the corresponding [consensus 4844 specs](https://github.com/sila/consensus-specs/blob/86fb82b221474cc89387fa6436806507b3849d88/specs/sila_deneb).

Specifically, we use the following methods from [`polynomial-commitments.md`](https://github.com/sila/consensus-specs/blob/86fb82b221474cc89387fa6436806507b3849d88/specs/sila_deneb/polynomial-commitments.md):

- [`verify_kzg_proof()`](https://github.com/sila/consensus-specs/blob/86fb82b221474cc89387fa6436806507b3849d88/specs/sila_deneb/polynomial-commitments.md#verify_kzg_proof)
- [`verify_blob_kzg_proof_batch()`](https://github.com/sila/consensus-specs/blob/86fb82b221474cc89387fa6436806507b3849d88/specs/sila_deneb/polynomial-commitments.md#verify_blob_kzg_proof_batch)
...
Execution layer test cases for this SIP can be found in the [`sip4844_blobs`](https://github.com/sila/execution-spec-tests/tree/1983444bbe1a471886ef7c0e82253ffe2a4053e1/tests/cancun/sip4844_blobs) of the `sila/execution-spec-tests` repository. Consensus layer test cases can be found [here](https://github.com/sila/consensus-specs/tree/2297c09b7e457a13f7b2261a28cb45777be82f83/tests/core/pyspec/sil2spec/test/sila_deneb).
