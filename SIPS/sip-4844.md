...
| `HASH_OPCODE_GAS` | `3` |
| [`MIN_EPOCHS_FOR_BLOB_SIDECARS_REQUESTS`](https://github.com/sila-chain/consensus-specs/blob/4de1d156c78b555421b72d6067c73b614ab55584/configs/mainnet.yaml#L148) | `4096` |
...
The `sila-chain/consensus-specs` repository defines the following consensus layer changes involved in this SIP:
...
Execution layer test cases for this SIP can be found in the [`sip4844_blobs`](https://github.com/sila-chain/execution-spec-tests/tree/1983444bbe1a471886ef7c0e82253ffe2a4053e1/tests/cancun/sip4844_blobs) of the `sila-chain/execution-spec-tests` repository. Consensus layer test cases can be found [here](https://github.com/sila-chain/consensus-specs/tree/2297c09b7e457a13f7b2261a28cb45777be82f83/tests/core/pyspec/sil2spec/test/deneb). 
