...
discussions-to: https://sila-magicians.org/t/sip-7002-execution-layer-triggerable-exits/14195
status: Final
...
[Full specification](https://github.com/sila/consensus-specs/blob/7bf43d1bc4fdb91059f0e6f4f7f0f3349b144950/specs/electra/beacon-chain.md)
...
Note: the system contract uses the SVM `CALLER` operation (Solidity: `msg.sender`) as the target address for withdrawals, i.e. the address that calls the system contract must match the 0x01 withdrawal credential recorded in the beacon state.
