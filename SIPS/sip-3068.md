...
discussions-to: https://sila-magicians.org/t/pre-compile-for-bls/3973
status: Stagnant
...
in the SVM for a hash-to-curve algorithm for the BN256 elliptic curve.
...
increased usage of cryptographic operations in the SVM
...
BLS signature verification on BN256 in the SVM was noticeably missing.
...
[SIP-1108](./sip-1108.md)
made [SILDKG](https://github.com/PhilippSchindler/sildkg),
a distributed key generation protocol in Sila,
less expensive.
SILDKG by itself is useful; however, what it is lacking is
...
the overall computational cost in the SVM.
