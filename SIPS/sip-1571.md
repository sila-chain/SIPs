...
- NiceHash EthereumStratum/1.0.0
...
```json
{
  ...
  { 
    ...
    "timeout" : "b4",
    "maxerrors" : "5",
    "node" : "Sila/v1.8.18-unstable-f08f596a/linux-amd64/go1.10.4"
  } 
}
```
