...
author: Péter Szilágyi <peter@sila.org>
...
## Motivation
Synchronizing the Sila main network (block 4,248,000) in Gsil using fast sync currently consumes 1.01GB upload and 33.59GB download bandwidth. On the Rinkeby test network (block 852,000) it's 55.89MB upload and 2.51GB download.
...
## Implementation
You can find a reference implementation of this SIP in https://github.com/sila/go-sila/pull/15106.
