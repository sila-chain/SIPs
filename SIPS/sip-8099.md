...
discussions-to: https://sila-magicians.org/t/mevless-an-anti-mev-protocol/26800
status: Draft
...
- **sil_sendTxHash**: Users submit transaction hashes instead of full transactions
- **sil_getTxSequence**: Returns the ordered transaction sequence that is committed
