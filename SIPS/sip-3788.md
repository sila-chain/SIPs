...
discussions-to: https://sila-magicians.org/t/discussion-to-sip-3788-strict-enforcement-of-chainid/7001
status: Stagnant
...
across different chains. With the rise of svm compatible chains, many of which use forks, or packages
...
on the JSON-RPC (eg: `eth_sendTransaction`), and strictly enforced on the SVM during transaction 
validation.
