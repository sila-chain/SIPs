---
sip: 8159
title: sil/71 - Block Access List Exchange
description: Adds peer-to-peer exchange of block-level access lists to the sil protocol
author: Toni Wahrstätter (@nerolation)
discussions-to: https://sila-magicians.org/t/sip-8159-sil-71-block-access-list-exchange/27725
status: Draft
...
The `block-access-list-hash` field contains `keccak256(rlp.encode(block-access-list))` as defined in [SIP-7928](./sip-7928.md). This field MUST be present in headers after the Amsterdam fork and absent for earlier blocks.
...
This SIP requires the Amsterdam hard fork for the header field extension. The new messages are only meaningful for post-Amsterdam blocks.
