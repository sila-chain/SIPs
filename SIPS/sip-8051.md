...
While the signature size (2.4kB) and public key size (1.3kB) are larger than other post-quantum candidates such as Falcon FN-DSA, this scheme is more flexible in terms of parameters. It is thus possible to derive a zero-knowledge version of Dilithium, keeping the security of the scheme tosilaer with an efficient in-circuit verification. This SIP does not dig into the details of this instance.
...
* The file [`mldsa_svm.rsp`](../assets/sip-8051/mldsa_svm.rsp) containing test vectors for the SVM-friendly version with the same format as NIST.
