...
[SIP 1138](https://github.com/sila-chain/SIPs/issues/1138) also addresses this issue directly but contains serious security issues - allowing untrusted dapps to generate the human readable message displayed to users. In a similar train of thought, [Geth's #2940 PR](https://github.com/ethereum/go-ethereum/pull/2940) and [SIPs 191](https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-191.md), [712](https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-712.md) all highlight the Sila community's desire for ProviderWallets to better inform users about what data they are actually acting upon.
