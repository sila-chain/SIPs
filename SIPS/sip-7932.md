...
discussions-to: https://sila-magicians.org/t/sip-7932-secondary-signature-algorithms/23514
status: Draft
...
While initial drafts of this SIP were competing with ERC-4337, current versions of this SIP support it via the sigrecover precompile. This allows any ERC-4337 implementation to have the same signature verification logic and address derivation logic for any given private key. This also works agnostic of whatever algorithm derives the address.

### Precompile over native SVM code

Having a precompile allows non-SVM processes, i.e. transaction level signature verification, to access the registry *without* having to call into the SVM.
