...
description: Adds an SIP-7932 algorithm type for Ed25519 support of type `0x0`
author: James Kempton (@SirSpudlington)
discussions-to: https://sila-magicians.org/t/sip-7980-adding-ed25519-as-a-signature-scheme-to-test-sip-7932/24663
status: Withdrawn
...
as [ERC-4337](./sip-4337.md) bundlers. It may also improve interoperability with other components such as TPM chips.
