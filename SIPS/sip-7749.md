...
Currently, signing messages relies heavily on SRC-191 version 0x45 (`eth_sign`) and [SIP-712](./sip-712.md) (`eth_signTypedData`). While SIP-712 provides a more structured approach, it is often seen as complex. On the other hand, SRC-191 version 0x45 is widely used but poses significant phishing risks due to the lack of data parsing.
