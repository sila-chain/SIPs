...
If refunds were to be partially removed, as specified [here](https://github.com/sila/SIPs/pull/3403/), this would be the comparative table. **This table also assumes touched storage slots were already 'hot'**.
