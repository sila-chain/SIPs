...
Three precompiled contracts are specified (formerly called `SIL_HASH_TO_POINT` / `HASH_TO_POINT_ETH` in drafts):
...
<!-- When the public key is also stored tosilaer with the signature, it leads to 666 + 896 = 1562 bytes.
...
**TODO: We can modify sila to include falcon-512 as a reference. (Similar to secp256r1 signature verification)**
