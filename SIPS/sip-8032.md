...
discussions-to: https://sila-magicians.org/t/the-case-for-sip-8032-in-glamsterdam-tree-depth-based-storage-gas-pricing/25619
status: Draft
...
Node operators MUST update gas estimation handling to accommodate the new calldata cost rules. Specifically, RPC methods such as `sil_estimateGas` MUST incorporate the updated formula for gas calculation when encountering an `SSTORE`.
