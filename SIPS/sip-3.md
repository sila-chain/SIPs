...
The actual call stack depth, as well as the call stack depth limit, are present in the SVM during execution, but just not available within the SVM. The implementation should be fairly simple and would provide a cheap and way to protect against call stack attacks.
