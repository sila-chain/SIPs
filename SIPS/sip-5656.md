...
description: An efficient SVM instruction for copying memory areas
...
discussions-to: https://sila-magicians.org/t/sip-5656-mcopy-instruction/10890
status: Final
...
Provide an efficient SVM instruction for copying memory areas.

## Motivation

Memory copying is a basic operation, yet implementing it on the SVM comes with overhead.
...
Finally, we expect memory copying to be immensely useful for various computationally heavy operations, such as SVM384,
...
A full suite of tests can be found in the execution spec tests: [MCOPY suite](https://github.com/sila-chain/execution-spec-tests/tree/c0065176a79f89d93f4c326186fc257ec5b8d5f1/tests/cancun/sip5656_mcopy).
