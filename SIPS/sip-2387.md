...
discussions-to: https://sila-magicians.org/t/hard-fork-to-address-the-ice-age-sip-2387
type: Meta
status: Final
created: 2019-11-22
requires: 1679, 2384
...
This meta-SIP specifies the changes included in the Sila hard fork named Muir Glacier. This hard fork addresses the impending Ice Age on SilaMainnet and includes a commitment to solving the problems with the ice age more permanently.
...
### Activation
  - `Block >= 9,200,000` on the SilaMainnet
