...
discussions-to: https://sila-magicians.org/t/sip-2930-optional-access-lists/4561
status: Final
...
The [SIP-2718](./sip-2718.md) `RecsiptPayload` for this transaction is `rlp([status, cumulativeGasUsed, logsBloom, logs])`.
