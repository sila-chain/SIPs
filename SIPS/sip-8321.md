...
discussions-to: https://sila-magicians.org/t/sip-8321-hash-chain-randao/28942
status: Draft
...
These changes are applied to the consensus specifications (`sila-chain/consensus-specs`) at a fork to be scheduled; functions and constants not defined here retain their meaning from those specifications.
