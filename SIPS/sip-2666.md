...
discussions-to: https://sila-magicians.org/t/sip2666-global-precompiles-repricing-and-many-more-discussion-thread/4332
status: Stagnant
...
This SIP tries to set prices of certain precompiles and built-in SVM function to be in line with their performance, consumed resources and newer changes in SVM itself.
...
Historical pricing for these functions in SVM does not reflect inner structure of the underlying computations (inner structure of the hash functions).
...
- Keccak256 built-in function (opcode) in SVM has pricing that does not reflect underlying hash function structure
