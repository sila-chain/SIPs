...
discussions-to: https://sila-magicians.org/t/sip-3300-phase-out-refunds/5434
status: Stagnant
...
Because the refund counter is separate from the gas counter, the block-to-block gas changes will not break `sil_estimateGas`.
