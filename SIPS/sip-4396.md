...
discussions-to: https://sila-magicians.org/t/sip-4396-time-aware-base-fee-calculation/7363
status: Stagnant
...
Under PoS, each slot has a [fixed assigned timestamp](https://github.com/sila/consensus-specs/blob/v1.1.3/specs/merge/beacon-chain.md#process_execution_payload), rendering any timestamp manipulation by block proposers impossible.
