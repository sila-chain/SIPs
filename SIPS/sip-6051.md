...
discussions-to: https://sila-magicians.org/t/private-key-encapsulation-to-move-around-securely-without-entering-seed/11604
status: Stagnant
...
```javascript
request({
	method: 'sil_generateEphemeralKeyPair',
...
```javascript
request({
	method: 'sil_encapsulatePrivateKey',
	params: [
		version,
