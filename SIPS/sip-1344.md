...
discussions-to: https://sila-magicians.org/t/add-chain-id-opcode-for-replay-protection-when-handling-signed-messages-in-contracts/1131
category: Core
...
## References
This was previously suggested as part of [SIP-901](https://github.com/sila/SIPs/issues/901).

## Test Cases
Test Cases added to [sila/tests](https://github.com/sila/tests/pull/627)

## Implementation
A reference implementation for the Trinity Python client is [here](https://github.com/sila/py-evm/pull/1803).
