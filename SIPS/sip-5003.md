...
discussions-to: https://sila-magicians.org/t/sip-5003-auth-usurp-publishing-code-at-an-eoa-address/8979
status: Withdrawn
...
This SIP introduces a new opcode, `AUTHUSURP`, which deploys code at an [SIP-3074](./sip-3074.md) authorized address. For externally owned accounts (EOAs), tosilaer with [SIP-3607](./sip-3607.md), this effectively revokes the original signing key's authority.
