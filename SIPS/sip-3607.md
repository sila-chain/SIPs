...
discussions-to: https://github.com/sila-chain/SIPs/issues/3608
status: Final
...
3. A contract can self destruct, with the stated intention that SRC20s (or other tokens) in the contract would be burned. However, they can now be accessed by a key for that address.
...
A diff to implement SIP-3607 in go-sila can be found [here](../assets/sip-3607/sila.diff)
