...
On the basis that both Gsil and Parity implement the same timestamp validation requirements, this should be written into the reference specification.
...
Both [Gsil](https://github.com/sila/go-sila/blob/4e474c74dc2ac1d26b339c32064d0bac98775e77/consensus/silash/consensus.go#L45) and [Parity](https://github.com/paritytech/parity-sila/blob/73db5dda8c0109bb6bc1392624875078f973be14/silcore/src/verification/verification.rs#L296-L307) reject blocks with timestamp more than 15 seconds in the future. This establishes a defacto standard, which should be made explicit in the reference specification.
