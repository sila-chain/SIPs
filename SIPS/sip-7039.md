...
discussions-to: https://sila-magicians.org/t/shadow-a-scheme-handler-discovery-option-for-wallets/14330
status: Stagnant
...
2. Create an `iframe` tag with a `src` attribute value of `web+svm://`; then
