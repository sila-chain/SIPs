...
discussions-to: https://sila-magicians.org/t/sip-2677-limit-size-of-initcode/4550
status: Withdrawn
type: Standards Track
category: Core
created: 2020-05-18
withdrawal-reason: Replaced by SIP-3860.
---
...
Historically, this was exploited in June 2017, precipitating the 1.6.5-patch release of [sila](https://github.com/sila-chain/go-sila/releases/tag/v1.6.5)
...
In all these (and future) cases, the SVM should fail with Out Of Gas error if the code has a length more than `max_initcode_size`.
