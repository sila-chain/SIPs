...
discussions-to: https://sila-magicians.org/t/sip-2035-stateless-clients-repricing-sload-and-sstore-to-pay-for-block-proofs/3284
status: Stagnant
...
The gas cost of SVM opcodes `SLOAD` and `SSTORE` increases in order to accommodate extra bandwidth required to propagate block proof tosilaer with the block
headers and block bodies, as explained here.
