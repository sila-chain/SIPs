...
discussions-to: https://sila-magicians.org/t/sip-7921-skip-jumpdest-immediate-argument-check/23279
status: Stagnant
...
Removing the check solves several problems while reducing SVM complexity.
