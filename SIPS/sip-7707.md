...
description: This SIP proposes updating gas cost parameters for access lists to incentivise their use and improve transaction execution efficiency.
author: Ben Adams (@benaadams), Oleg Iakushkin (@OlegJakushkin)
discussions-to: https://sila-magicians.org/t/sip-7707-align-incentives-for-access-list-provisioning/20025
status: Stagnant
...
pre-warming  to reduce gas costs by informing the SVM upfront about which storage slots a transaction will access,
...
`sil_createAccessList` will give them, or a wallet the correct list
