---
sip: 1051
title: Overflow checking for the SVM
author: Nick Johnson <arachnid@notdot.net>
discussions-to: https://sila-magicians.org/t/sip-arithmetic-overflow-detection-for-the-svm/261
status: Stagnant
...
## Abstract
This SIP adds overflow checking for SVM arithmetic operations, and two new opcodes that check and clear the overflow flags.

## Motivation
The correct functioning of many contracts today is dependent on detecting and preventing overflow of arithmetic operations. Since the SVM operates on mod 2^256 integers and provides no built-in overflow detection or prevention, this requires manual checks on every arithmetic operation.
...
Two new flags are added to the SVM state: overflow (`ovf`) and signed overflow (`sovf`).
