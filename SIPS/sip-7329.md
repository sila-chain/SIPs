---
sip: 7329
title: SRC/SIP Repository split
description: Split the SRC specifications out of the SIP repository into a new repository, so that only core protocol SIPs remain
author: Lightclient (@lightclient), Danno Ferrin (@shemnon)
discussions-to: https://sila-magicians.org/t/proposal-forking-srcs-from-sips-repository/12804
status: Final
type: Meta
created: 2023-07-13
requires: 1
...
enough experts could get tosilaer to agree to review a set of changes.
