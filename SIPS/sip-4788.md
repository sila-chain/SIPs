...
This root consumes 32 bytes and is exactly the [hash tree root](https://github.com/sila/consensus-specs/blob/fa09d896484bbe240334fa21ffaa454bafe5842e/ssz/simple-serialize.md#merkleization) of the parent beacon block for the given execution block.
...
Clients may decide to omit an explicit SVM call and directly set the storage values. Note: While this is a valid optimization for SilaMainnet, it could be problematic on non-sila-mainnet situations in case a different contract is used.
