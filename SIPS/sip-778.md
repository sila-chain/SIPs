---
sip: 778
title: Sila Node Records (ENR)
author: Felix Lange <fjl@sila.org>
type: Standards Track
category: Networking
status: Final
created: 2017-11-23
discussions-to: https://github.com/sila-chain/devp2p/issues/43
---
...
- To sign record `content` with this scheme, apply the keccak256 hash function (as used by
  the SVM) to `content`, then create a signature of the hash. The resulting 64-byte
