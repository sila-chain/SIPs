...
discussions-to: https://sila-magicians.org/t/sip-8304-trustless-log-and-transaction-index/28824
status: Draft
...
Note: Alternatively clients can choose to directly write to the storage of the contract but SVM calling the contract remains preferred.
...
Exact svm assembly that can be used for the index contract:
