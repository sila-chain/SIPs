...
discussions-to: https://sila-magicians.org/t/sip-7519-atomic-storage-operations-scredit-and-sdebit/15818
status: Stagnant
...
There has been a large amount of energy around parallel SVMs across multiple
chains, however there is a lack of parallel primitives within the SVM to support
...
These semantics could be implemented in the SVM today, but it would also include
a SLOAD, DUP, LT, JUMPI and REVERT instructions. The SVM, however, can do these
...
There is no SVM functionality removed by this proposal.
