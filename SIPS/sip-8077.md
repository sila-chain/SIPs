---
sip: 8077
title: sil/XX - announce transactions with nonce
description: Adds source and nonce to transaction announcements
author: Csaba Kiraly (@cskiraly)
discussions-to: https://sila-magicians.org/t/sip-8077-sil-xx-add-nonce-and-source-to-transactions-announcement/26505
status: Draft
...
This SIP improves mempool propagation, extending the devp2p 'sil' protocol's `NewPooledTransactionHashes` message to also announce each transaction's source address and nonce tosilaer with the already announced hash, type, and size.
