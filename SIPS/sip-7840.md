...
discussions-to: https://sila-magicians.org/t/add-blob-schedule-to-execution-client-configuration-files/22182
status: Final
type: Informational
created: 2024-12-12
---
...
for various activities. For example, the `sil_feeHistory` RPC method returns a
