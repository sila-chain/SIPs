...
- One in Rust language that is based on the [SIP-196](./sip-196.md) code and integrated with Sila for this library
- One implemented specifically for Sila as a part of the current codebase
