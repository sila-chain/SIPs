...
discussions-to: https://sila-magicians.org/t/sip2537-bls12-precompile-discussion-thread/4187
status: Final
...
- One in Rust language that is based on the [SIP-196](./sip-196.md) code and integrated with OpenSila for this library
- One implemented specifically for Gsil as a part of the current codebase
