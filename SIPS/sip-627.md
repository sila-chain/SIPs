...
This SIP should substitute the [existing specification](https://github.com/sila/wiki/wiki/Whisper-Wire-Protocol).
More detailed documentation on Whisper could be found [here](https://github.com/sila/go-sila/wiki/Whisper).
