...
discussions-to: https://sila-magicians.org/t/sip-3155-create-evm-trace-specification/5007
status: Last Call
...
This SIP is fully backward compatible with go-sila. OpenSila, Besu and Nethermind clients would have to change their JSON output of
`opensila-evm` `evmtool` and
