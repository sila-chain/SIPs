---
sip: 3155
title: SVM trace specification
description: A JSON format for SVM traces
author: Martin Holst Swende (@holiman), Marius van der Wijden (@MariusVanDerWijden)
discussions-to: https://sila-magicians.org/t/sip-3155-create-svm-trace-specification/5007
status: Last Call
...
This SIP is fully backward compatible with go-ethereum. OpenEthereum, Besu and Nethermind clients would have to change their JSON output of
`openethereum-svm` `svmtool` and
