...
This report presents an empirical analysis of Block Access List (BAL) sizes across 100 historical Sila blocks. The analysis examines BAL encoding efficiency using SSZ format and compares configurations with and without storage read tracking.
