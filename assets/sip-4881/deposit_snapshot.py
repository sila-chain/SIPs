...
from sip_4881 import DEPOSIT_CONTRACT_DEPTH,Hash32,sha256,to_le_bytes,zerohashes
...
class DepositTree:
    ...
    def finalize(self, sil1_data: Sil1Data, execution_block_height: uint64):
        self.finalized_execution_block = (sil1_data.block_hash, execution_block_height)
        self.tree.finalize(sil1_data.deposit_count, DEPOSIT_CONTRACT_DEPTH)
