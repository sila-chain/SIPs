...
from sip_4881 import DepositData,Sil1Data,Hash32,sha256,uint64,zerohashes
    ...
    with open(filename, "r") as file:
        try:
            ...
            for test_case in test_cases:
                ...
                sil1_data = Sil1Data(
                    get_bytes(test_case['sil1_data']['deposit_root']),
                    int(test_case['sil1_data']['deposit_count']),
                    get_bytes(test_case['sil1_data']['block_hash'])
                )
                finalized = []
...
def test_deposit_cases():
    ...
    for case in test_cases:
        ...
        expected = case.sil1_data.deposit_root
...
def test_finalization():
    ...
    assert(original_root == test_cases[127].sil1_data.deposit_root)
    tree.finalize(test_cases[100].sil1_data, test_cases[100].block_height)
    ...
    tree.finalize(test_cases[105].sil1_data, test_cases[105].block_height)
...
def test_snapshot_cases():
    ...
    for case in test_cases:
        tree.finalize(case.sil1_data, case.block_height)
