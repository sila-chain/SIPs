"""The SVM opcode table shared by the SIP-8337 validators.
...
immediate.  Current through the SilaPrague fork, plus this SIP's three
...
# through the SilaPrague fork, plus this SIP's three.
TABLE = {
    0x00: (0, 0, True),                                       # STOP
