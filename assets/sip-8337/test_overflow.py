...
TESTS = [
    ...
    # --- SIP test cases ---
    ("simple routine (SIP)",       "6004B000B1B2", True),
    ("two-level subroutines (SIP)","6004B000B16009B0B2B1B2", True),
    ("dest outside code (SIP)",    "60FFB000B1B2", False),
    ("bare RETURNSUB (SIP)",       "B2", False),
    ("subroutine at end (SIP)",    "600556B1B25B6003B0", True),
