/* Baseline SVM interpreter for the 2x2 measurement.
 *
 * This is the status quo cell: bytecode interpreted at run time, with
 * everything a sila-mainnet client must do — JUMPDEST analysis before the
 ...
 * common case on sila-mainnet), 256-step shift-subtract otherwise. */
