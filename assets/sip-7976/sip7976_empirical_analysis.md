# SIP-7976 Empirical Report (64/64 Pricing at the Floor)

*The following represents a summary with empirical findings from analyzing SIP-7976's impact on transactions.*
*Date: January, 2026*
...
| Transactions already affected by SIP-7623 | 2,093,004 (0.85%) |
| New transactions affected by SIP-7976 only | 2,942,610 (1.20%) |
| SIP-7623 overlap percentage | 41.6% |
...
## SIP-7623 Interaction Analysis

### Linear Cost Increase

The analysis reveals that **41.6% of transactions affected by SIP-7976 are already impacted by SIP-7623**. This means:

- **2,093,004 transactions** (0.85% of all transactions) will experience **linear cost increases** as calldata pricing moves from SIP-7623 rates to SIP-7976 rates
- **2,942,610 transactions** (1.20% of all transactions) represent new impact from SIP-7976

### Pricing Structure Comparison

| Byte Type | Current | SIP-7623 | SIP-7976 | 7623→7976 Increase |
|-----------|---------|----------|----------|-------------------|
...
2. **SIP-7623 Linear Escalation**: A significant portion of affected transactions (41.6%) will see linear cost increases from existing SIP-7623 pricing
