# Optimism-gsil with NTT Precompiles (liboqs Implementation)

Fork of `op-gsil` with precompiled contracts for Number Theoretic Transform (NTT) operations using open-quantum-safe liboqs via CGO bindings, enabling efficient on-chain post-quantum cryptographic operations.
