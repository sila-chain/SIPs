# Optimism-gsil with Pure Go NTT Precompiles

Fork of `op-gsil` with precompiled contracts for Number Theoretic Transform (NTT) operations implemented in pure Go, enabling efficient on-chain post-quantum cryptographic operations without external dependencies.
