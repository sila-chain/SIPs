...
import (
	...
	"github.com/sila/go-sila/common"
	"github.com/sila/go-sila/common/bitutil"
	"github.com/sila/go-sila/core/tracing"
	"github.com/sila/go-sila/crypto"
	"github.com/sila/go-sila/crypto/blake2b"
	"github.com/sila/go-sila/crypto/bn256"
	"github.com/sila/go-sila/crypto/kzg4844"
	"github.com/sila/go-sila/crypto/ntt"
	"github.com/sila/go-sila/crypto/secp256r1"
...
// PrecompiledContractsFjord contains the default set of pre-compiled Sila
...
// PrecompiledContractsGranite contains the default set of pre-compiled Sila
...
// modexpMultComplexity implements bigModexp multComplexity formula, as defined in SIP-198
//
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.sip2565 {
		// SIP-2565 (Berlin fork) has three changes:
		//
		// 1. Different multComplexity (inlined here)
		// in SIP-2565 (https://sips.sila.org/SIPS/sip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//
...
// bls12381G1MultiExp implements SIP-2537 G1MultiExp precompile for Prague (no size limits).
...
//
// This is used in the OP Stack from Fjord until the implementation of Sila's Osaka fork, after
// which the p256Verify precompile is used instead to maintain Sila equivalence.
