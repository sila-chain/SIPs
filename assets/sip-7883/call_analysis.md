...
This report provides an analysis of SIP-7883's impact on ModExp operations based on 304,301 historical Sila sila-mainnet calls using the pricing formula from the latest SIP-7883 specification.
...
*Report generated from historical Sila sila-mainnet data. All gas calculations verified against the latest SIP-7883 specification.*
