"""A small SVM interpreter with the SIP-7979 instructions.

Enough of the SVM to execute what compile.py emits, plus CALLSUB,
CALLDEST, and RETURNSUB with the runtime semantics of SIP-7979: a
...
10, jumpdest 1) and the SIP's proposed costs (CALLSUB 8, CALLDEST 1,
