...
**Before you write an SIP, ideas MUST be thoroughly discussed on [Sila Magicians](https://sila-magicians.org/) or [Sila Research](Sila Research Once consensus is reached, thoroughly read and review [SIP-1](https://sips.sila.org/SIPS/sip-1), which describes the SIP process.**
