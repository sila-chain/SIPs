...
* Do not use articles (the/a/an/etc.) in front of SIP identifiers (so not "an SRC-20"), unless the SIP identifier is used as an adjective/compound noun (so "an SRC-20 token" is fine.)
